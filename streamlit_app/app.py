...
with col1:
    ...
    with bath_col:
        ...
        bathrooms = st.selectbox("Bedrooms", options=[1, 1.5, 2, 2.5, 3, 3.5, 4], index=2, label_visibility="collapsed")
    ...
    year_built = st.slider("Square Footage", 1900, 2025, 2000, 1, label_visibility="collapsed", key="year")
